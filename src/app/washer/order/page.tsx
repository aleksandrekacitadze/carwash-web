...
import WasherCancelOrderButton
from "@/components/WasherCancelOrderButton";
        ...
        <div style={S.grid}>
          <section style={S.card}>
            ...
            <div style={S.swipeBox}>
              ...
              <WasherCancelOrderButton
  orderId={order.id}
  status={order.status}
  paymentMode={order.paymentMode}
  paymentStatus={order.paymentStatus}
  isPaid={order.isPaid}
  onCanceled={fetchOrder}
/>
...
const S: Record<string, React.CSSProperties> = {
  ...
  mapFake: {
    ...
    border: "1px solid var(--line)",
    background:
      "radial-gradient(1200px 500px at 20% 10%, var(--accent-soft), rgba(0,0,0,0.20)), rgba(0,0,0,0.18)",
    padding: 14,
    display: "flex",
    gap: 12,
